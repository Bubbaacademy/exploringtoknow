...
export async function Header() {
  ...
  // Public magazine header: topic/category navigation only. No auth/SaaS CTA is
  // surfaced here — operator/editorial/admin sign-in lives in the footer (low
  // visibility); every gated route still verifies the session server-side.
  return (
