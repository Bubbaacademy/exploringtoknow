...
export default async function SellerSubmissionsPage({ searchParams }: Args) {
  ...
  return <SubmissionList scope={ws.scope} kind="seller" status={status} newestFirst={newestFirst} />;
}
