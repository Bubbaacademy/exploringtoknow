...
import {
  Section, Stat, Card, Empty, Badge, StatusBadge, statusVariant, TrendBars,
...
// The editorial vocabulary (status/type labels + badges) is defined there too, so
// /app and /dashboard describe the same editorial states identically.
export {
  Section, Stat, Card, Empty, Badge, StatusBadge, statusVariant, TrendBars,
  EditorialStatusBadge, PublicStateBadge, EDITORIAL_STATUS_LABEL, ARTICLE_TYPE_LABEL,
};
