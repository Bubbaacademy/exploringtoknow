...
const NAV: Array<{ group: string; items: Array<[string, string]> }> = [
  ...
  { group: 'Growth', items: [['Ads Studio', '/app/ads'], ['Performance', '/app/performance'], ['Connections', '/app/provider-connections'], ['Analytics', '/app/analytics'], ['Newsletter', '/app/newsletter'], ['Contact Inbox', '/app/contact']] },
