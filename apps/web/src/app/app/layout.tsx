...
const NAV: Array<{ group: string; items: Array<[string, string]> }> = [
  ...
  { group: 'Content', items: [['Articles', '/app/articles'], ['Products', '/app/products'], ['Categories', '/app/categories'], ['Media', '/app/media'], ['Brand Kit', '/app/brand'], ['Landing Pages', '/app/landing-pages']] },
